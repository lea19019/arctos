...
> **Status: this proposal became a negative result.** Everything below is
> written in the future tense, as a live plan; it is kept because the reasoning
> is the clearest statement of the idea. The experiment ran in `q6` and the
> outcome was a wash — protecting the language-specific endpoints versus the
> neutral middle did not beat uniform allocation, on 7 of 8 models (Gemma's job
> died and was never resubmitted). This is the Q5 null reconfirmed at stage
> level. See [`phase2_synthesis.md`](phase2_synthesis.md) and
...
- Phase one (pivot, depth pipeline, DLA heads): `compression/report/`, `compression/docs/q1_language_emergence.md`,
  `q4_architecture_comparison.md`. Super weights: `compression/docs/phase2_method_primer.md`.
