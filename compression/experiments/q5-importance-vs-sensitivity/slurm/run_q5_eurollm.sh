#!/usr/bin/env bash
#SBATCH --job-name=arctos-q5-eurollm
...
#SBATCH --output=logs/q5_eurollm_%j.out
#SBATCH --error=logs/q5_eurollm_%j.err
set -euo pipefail
...
.venv/bin/python -u experiments/q5-importance-vs-sensitivity/experiment.py \
    ...
    --q1-results results/eurollm-9b-instruct/q1 \
    --output results/eurollm-9b-instruct/q5
echo "===== done $(date) ====="
