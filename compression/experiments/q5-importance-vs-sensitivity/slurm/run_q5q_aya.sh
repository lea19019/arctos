#!/usr/bin/env bash
#SBATCH --job-name=arctos-q5q-aya
...
#SBATCH --output=logs/q5q_aya_%j.out
#SBATCH --error=logs/q5q_aya_%j.err
set -euo pipefail
...
.venv/bin/python -u experiments/q5-importance-vs-sensitivity/quality_sensitivity.py \
    ...
    --q1-results results/aya-expanse-8b/q1 --output results/aya-expanse-8b/q5 \
