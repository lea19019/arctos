#!/usr/bin/env bash
#SBATCH --job-name=arctos-q5q-llama-3.1
...
#SBATCH --output=logs/q5q_llama-3.1_%j.out
#SBATCH --error=logs/q5q_llama-3.1_%j.err
set -euo pipefail
...
.venv/bin/python -u experiments/q5-importance-vs-sensitivity/quality_sensitivity.py \
    ...
    --q1-results results/llama-3.1-8b-instruct/q1 --output results/llama-3.1-8b-instruct/q5 \
