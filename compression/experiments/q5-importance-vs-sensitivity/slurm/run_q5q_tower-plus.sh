#!/usr/bin/env bash
#SBATCH --job-name=arctos-q5q-tower-plus
...
#SBATCH --output=logs/q5q_tower-plus_%j.out
#SBATCH --error=logs/q5q_tower-plus_%j.err
set -euo pipefail
...
.venv/bin/python -u experiments/q5-importance-vs-sensitivity/quality_sensitivity.py \
    ...
    --q1-results results/tower-plus-9b/q1 --output results/tower-plus-9b/q5 \
