#!/usr/bin/env bash
#SBATCH --job-name=arctos-q6-eurollm
...
#SBATCH --output=logs/q6_eurollm-9b-instruct_%j.out
#SBATCH --error=logs/q6_eurollm-9b-instruct_%j.err
set -euo pipefail
...
.venv/bin/python -u experiments/q6-compression/experiment.py \
    --config experiments/q6-compression/configs/eurollm-9b-instruct.yaml \
    --output results/eurollm-9b-instruct/q6 \
