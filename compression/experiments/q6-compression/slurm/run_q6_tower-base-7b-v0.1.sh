#!/usr/bin/env bash
#SBATCH --job-name=arctos-q6-tower-base
...
#SBATCH --output=logs/q6_tower-base-7b-v0.1_%j.out
#SBATCH --error=logs/q6_tower-base-7b-v0.1_%j.err
set -euo pipefail
...
.venv/bin/python -u experiments/q6-compression/experiment.py \
    --config experiments/q6-compression/configs/tower-base-7b-v0.1.yaml \
    --output results/tower-base-7b-v0.1/q6 \
