...
**Expected artifacts.** Per-model layer charts (probe accuracy + selectivity, target-token mass under logit lens) under `compression/experiments/q1-language-emergence/`; synthesis in `docs/findings/q1.md`.
