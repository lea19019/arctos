...
interests you. (arXiv IDs from `docs/research.md`, mostly verified.)
...
- `docs/findings/phase2-synthesis.md` (conclusions) · `phase2-results.md` (tables) · `compression-primer.md` · `phase2-method-primer.md`.
- `docs/research.md` — annotated bibliography + 3 deep-research syntheses; raw reports in `docs/findings/deep-research-raw/`.

---

## 🎓 Foundations — learn the background (videos + sites)

**Math (do these first — see `docs/MATH-PLAN.md`):**
