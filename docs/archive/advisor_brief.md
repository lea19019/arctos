...
- Method primer (the gem + literature gaps): `compression/docs/phase2_method_primer.md`
- Framework + reading list: `compression/docs/compression_primer.md`
- Phase-two results: `compression/docs/q6_compression.md`; collectors `compression/scripts/q6gem_collect.py`
- Replication plan for the closest prior paper: `docs/archive/replication_uneven_ptq_brief.md`
