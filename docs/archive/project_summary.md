...
`learning/annotated_bibliography.md` is reference material *for phase two* — not the scaffold for
...
Deliberately deferred. `docs/archive/phase2_hypotheses.md` is a seed document
