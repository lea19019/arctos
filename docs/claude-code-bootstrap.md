...
(`docs/findings/architecture-comparison.md`) that someone unfamiliar
...
(`docs/phase2-hypotheses.md`) about what compression strategies the
...
- Context (1 paragraph linking to project-summary.md)
...
`docs/project-summary.md` — written first, before any of the scaffold —
...
2. Write `docs/project-summary.md` first. Do not produce anything else
...
4. Once I confirm: produce the repo scaffold, PHASE1-PLAN.md, the
...
- **Candidate C — Task-specific calibration data for existing
  ...
  WMT25 gap from `research.md` directly.
