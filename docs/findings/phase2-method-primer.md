...
Primer #1 (`compression-primer.md`) gave the find/keep/shrink/prune framework
...
> and are independently replicating it (`docs/replication-uneven-ptq-mt-brief.md`).
...
`wf_36650cc2-1b3` (2026-06-02). Reading list + mechanics: `compression-primer.md`.
