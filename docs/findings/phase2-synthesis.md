...
## Pointers
GPTQ gem + tables: `phase2-results.md`. Method/novelty + reading list:
`phase2-method-primer.md`, `compression-primer.md`. Pipeline direction (now a
negative): `phase2-novel-direction.md`. Deep-research raw:
`docs/findings/deep-research-raw/`. Replication of 2508.20893 (separate effort):
`docs/replication-uneven-ptq-mt-brief.md`.
