...
> `experiments/q6-compression/experiment.py`; data: `results/{model}/q6/
> q6_summary.json`; framework + reading list: `compression-primer.md`.
...
Variant A/C in `docs/research.md` and aims at the empty WMT25 Pareto region
...
`results/{model}/q6/q6_summary.json` (all stages, all pairs) + `fisher.npz`.
