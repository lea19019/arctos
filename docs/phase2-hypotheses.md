...
Run GPTQ / AWQ / LeanQuant with MT parallel calibration data (or activations from MT-critical components per Q2/Q3) instead of generic C4. Orthogonal to A and B; lower-risk; addresses the WMT25 calibration gap directly (`docs/research.md` §1D).
