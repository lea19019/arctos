...
- `docs/findings/compression-nllb-xtts-research.md` — Full compression survey for NLLB and XTTS (PTQ, pruning, distillation state of the art, open gaps, paper list)
- `docs/findings/interp-lrl-nllb-xtts.md` — Interpretability map for LRL-preserving quantization: mechanistic findings, bit-allocation implications, full experimental roadmap
- `docs/research.md` — Arctos comprehensive survey of decoder-only LLM compression (Sections 1–3: pruning, quantization, recovery/distillation)
- `docs/findings/q5.md` — Q5 null result: importance ≠ quantization sensitivity
- `docs/findings/q6.md` — Q6 phase-two results: super-weights, Wanda, 3-bit cliff, MT calibration
- `docs/findings/replication-uneven-ptq-mt.md` — PTQ-MT replication findings (C1–C5, LRL+2-bit nexus)
- `PHASE1-PLAN.md` — Full phase-one plan and V1/V2/V3 claim structure
