#!/usr/bin/env bash
#SBATCH --job-name=arctos-q5-bloom
...
#SBATCH --output=logs/q5_bloom_%j.out
#SBATCH --error=logs/q5_bloom_%j.err
set -euo pipefail
...
.venv/bin/python -u experiments/q5-importance-vs-sensitivity/experiment.py \
    ...
    --q1-results results/bloom-7b1/q1 \
    --output results/bloom-7b1/q5
echo "===== done $(date) ====="
