#!/usr/bin/env bash
#SBATCH --job-name=arctos-q5q-gemma3
...
#SBATCH --output=logs/q5q_gemma3_%j.out
#SBATCH --error=logs/q5q_gemma3_%j.err
set -euo pipefail
...
.venv/bin/python -u experiments/q5-importance-vs-sensitivity/quality_sensitivity.py \
    ...
    --q1-results results/gemma-3-12b-it/q1 --output results/gemma-3-12b-it/q5 \
