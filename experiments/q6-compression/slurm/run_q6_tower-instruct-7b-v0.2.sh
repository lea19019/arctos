#!/usr/bin/env bash
#SBATCH --job-name=arctos-q6-tower-instruct
...
#SBATCH --output=logs/q6_tower-instruct-7b-v0.2_%j.out
#SBATCH --error=logs/q6_tower-instruct-7b-v0.2_%j.err
set -euo pipefail
...
.venv/bin/python -u experiments/q6-compression/experiment.py \
    --config experiments/q6-compression/configs/tower-instruct-7b-v0.2.yaml \
    --output results/tower-instruct-7b-v0.2/q6 \
